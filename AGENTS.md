...
3. this `AGENTS.md`
4. the current task / issue / implementation prompt
...
`docs/MIGRATION_PLAN.md` is the approved implementation sequence and source-disposition plan.
...
Individual implementation prompts or work units may specify a newer exact base/head. Those explicit work-unit identities supersede this historical baseline.
...
Treat these as migration inputs, not target architecture.
...
## 11. Operational Status and Retry
...
## 13. Dependency and Package Discipline
...
## 14. Setup and Validation Commands
...
## 21. Before You Finish Any Implementation Task
...
Prefer deletion and simplification when the target architecture makes legacy infrastructure unnecessary, but only after the replacement path is proven.
