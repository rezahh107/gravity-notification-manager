...
/**
 * Tests the pure cutover state-machine ordering.
 */
final class CutoverSequenceTest extends TestCase {

	/**
	 * Greenfield authority cannot open before legacy inactivity is verified.
	 *
	 * @return void
	 */
	...
	/**
	 * Failed target readiness leaves legacy authority unchanged.
	 *
	 * @return void
	 */
	...
	/**
	 * Rollback closes greenfield before restoring legacy authority.
	 *
	 * @return void
	 */
